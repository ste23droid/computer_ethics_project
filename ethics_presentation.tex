...
\begin{itemize}
	...
	\item \textbf{Without templates}
		\begin{itemize}
			\item DialogFlow and integrated NLP engine
...
\begin{block}{Invitation/Inhibition} 
	\begin{quote}
		The scripts of artifacts suggest specific actions and discourage others (\cite{verbeek2011moralizing})
	\end{quote}

\begin{itemize}
	\item Fullfillment = application logic
	\item Developers create the logic of the interaction by enabling some actions and inhibiting some others. 
	\item The conversational interaction doesn't go on if the use hasn't included all the expected parameters in the answer
\end{itemize}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{images/invitation_inhibition}
	\caption{DialogFlow building interactions}

...
\begin{itemize}
	\item Two perspectives of technological mediation:
	\begin{itemize}
		\item Perception
...
\begin{itemize}
	\item \textbf{With templates}
			...
			\begin{itemize}
				{\small  \item build apps \textbf{without writing a single line of code} \dots
				   %what about the future?
			 	 \item  build apps quickly \textbf{without worrying about designing conversations} \dots}
		 	 	\smallskip
...
\begin{frame}
	...
	\begin{itemize}
		\item Designing is \textbf{''materializing morality''} (\cite{verbeek2011moralizing})

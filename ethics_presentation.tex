	...
	\begin{columns}
		\column{0.58\linewidth}
			\begin{block}{Suggestion Chip}
		 		...
		 		\end{quote}
	 		\end{block}
	 		% If during the conversation there is a primary call for action, consider listing that as the first suggestion chip 
	 		
	 		
		\column{0.38\linewidth}
			\centering
			\includegraphics[width=1\linewidth]{images/suggestion-chip}
	\end{columns}
